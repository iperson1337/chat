...
use Iperson1337\Chat\Tests\Helpers\Models\Bot;
use Iperson1337\Chat\Tests\Helpers\Models\Client;
...
class MessageTest extends TestCase
{
    ...
    {
        $this->app['config']->set('iperson1337_chat.sender_fields_whitelist', [
            'name', 'bot_id',
        ]);

...
use Iperson1337\Chat\ChatServiceProvider;
use Iperson1337\Chat\Facades\ChatFacade;
use Iperson1337\Chat\Tests\Helpers\Models\User;
...
class TestCase extends \Orchestra\Testbench\TestCase
{
    ...
    {
        $config = config('iperson1337_chat');
...
//         ]);
        ...
        $app['config']->set('iperson1337_chat.user_model', 'Iperson1337\Chat\Tests\Helpers\Models\User');
        $app['config']->set('iperson1337_chat.sent_message_event', 'Iperson1337\Chat\Eventing\MessageWasSent');
        $app['config']->set('iperson1337_chat.broadcasts', false);
        $app['config']->set('iperson1337_chat.user_model_primary_key', null);
        $app['config']->set('iperson1337_chat.routes.enabled', true);
        $app['config']->set('iperson1337_chat.should_load_routes', true);
    }
